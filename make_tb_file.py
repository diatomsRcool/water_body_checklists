...
for line in in_file:
    ...
    if species == '' or genus == '': #if its not identified to species, then we don't want it
        ...
        if taxon in taxa: #remove accidental duplication
            ...
            out_file.write(meas_id + '\t' + occur_id + '\t' + '' + '\t' + 'true' + '\t' + 'http://eol.org/schema/terms/Present' + '\t' + 'http://www.marineregions.org/gazetteer.php?p=details&id=' + p + '\t' + 'R01|R02' + '\t' + 'Compiler: Anne E Thessen' + '\t' + 'http://gimmefreshdata.github.io/?limit=5000000&taxonSelector=' + taxon + '&traitSelector=&wktString=' + polygon + '\n')
